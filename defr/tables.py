...
class Contract(db.Model):
    ...
    term = db.Column(db.Integer, db.CheckConstraint('term > 0'))
    annual_amount = db.Column(db.Numeric(10,2), db.CheckConstraint('annual_amount > 0'))
    ...
    price_increase = db.Column(db.Integer, nullable=False)
